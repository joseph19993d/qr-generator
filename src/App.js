              ...
              <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
                ...
                <ul className="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-4  p-2  animate__animated ">
                  ...
                  {qrCodes.map((code, index) => (
                    <div key={index} className='group block overflow-hidden  bg-purple-600 rounded-b-[10px] rounded-t-[10px] w-[285px] h-[395px] m-auto p-[10px]'>
                      <div id={`qr-code-${index}`} className=' bg-none w-[265px] h-[265px]  p-1 flip-2-hor-bottom-1'>
                        <QRCode value={code} bgColor={'rgba(250, 250, 250, 0)'}  />
                      </div>
                      <button onClick={() => handleDownloadQRCode(index)}  className='  ml-2 bg-purple-900 px-4 py-3 text-white rounded mt-2  '>Download</button>
                      <button className='  ml-2 bg-purple-900 px-4 py-3 text-white rounded mt-2  '>Delete</button>
